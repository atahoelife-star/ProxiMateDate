...
export function AboutPage() {
  return (
    <PageShell kicker="A TAHOE LIFE" title="About ProxiMateDate">
      ...
      <p>
        This is a website (desktop and mobile). There is no iOS or Android app. Free Date Night is open for 30 minutes (the host can extend for $2.99). Restaurant is $9.99 for 90 minutes after you sit. Movie Night is $14.99 for 2.5 hours. Both start after you pay with a card on Stripe. Premium is $24.99 for 3 hours covering both. Netflix stays on your own apps.
      </p>
      <p>
