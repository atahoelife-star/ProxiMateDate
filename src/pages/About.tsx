...
export function AboutPage() {
  return (
    <PageShell kicker="A TAHOE LIFE" title="About ProxiMateDate">
      ...
      <p>
        This is a browser product (desktop and mobile web). There is no iOS or Android app in this release, and there is no in-app purchase. Free Date Night is open. Restaurant ($9.99) and Movie Night ($14.99) start after you pay with a card on Stripe Checkout. Netflix companion mode does not embed Netflix.
      </p>
      <p>
