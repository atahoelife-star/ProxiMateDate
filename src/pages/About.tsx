...
export function AboutPage() {
  return (
    <PageShell kicker="A TAHOE LIFE" title="About ProxiMateDate">
      ...
      <p>
        This is a browser product (desktop and mobile web). There is no iOS or Android app in this release, and there is no in-app purchase. Today you can open three free rooms: a restaurant walk-in with waiter clips, a movie-night theater with YouTube Watch Together, and a simple chat date night. Netflix companion mode does not embed Netflix.
      </p>
      <p>
