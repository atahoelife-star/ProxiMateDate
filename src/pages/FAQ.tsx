...
export function FaqPage() {
  return (
    <PageShell kicker="ANSWERS" title="FAQ">
      ...
      <p>
        Free Date Night is free for 30 minutes. About three minutes before it ends, the host (not the guest) can pay $2.99 on Stripe to extend. Dinner is $9.99 for 90 minutes after you sit. Movie Night is $14.99 for 2.5 hours. Both are paid before those rooms start. Premium is $24.99 for 3 hours covering both. Pay with a card on Stripe. We do not send you to PayPal, Venmo, or Cash App. See <Link to="/pricing" className="text-[#C9A962] underline">Pricing</Link>.
      </p>
