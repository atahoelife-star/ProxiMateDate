        ...
        <div className="grid grid-cols-5 gap-2 sm:gap-3">
          {RESTAURANT_ARRIVAL.map((beat) => (
            <button
              ...
              className="group relative aspect-[3/4] sm:aspect-[4/5] rounded-xl overflow-hidden border border-white/15 hover:border-[#C9A962] focus:outline-none focus:border-[#C9A962]"
            >
