  ...
  return (
    <section className="mt-10 table-linen scroll-mt-28" id="dinner-menus">
      ...
      <p className="text-[#D4C4B4] text-sm mb-6 max-w-3xl">
        ...
        plate. {partnerName} orders on their screen. Call Waiter brings what you picked — ribeye plays
        steak, cauliflower plays the plant plate. Their dishes play on their screen, not yours.
      </p>
